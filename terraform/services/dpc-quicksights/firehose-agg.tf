...
resource "aws_kinesis_firehose_delivery_stream" "firehose-ingester-agg" {
  ...
  extended_s3_configuration {
    ...
    prefix      = "databases/${local.agg_profile}/metric_table=!{partitionKeyFromLambda:metric_table}/year=!{partitionKeyFromLambda:timestamp:yyyy}/month=!{partitionKeyFromLambda:timestamp:MM}/"
