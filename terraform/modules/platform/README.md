...
| [aws_nat_gateway.cdap](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/nat_gateway) | data source |
...
| [aws_nat_gateways.cdap](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/nat_gateways) | data source |
...
| [aws_vpc.cdap](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/vpc) | data source |
...
| Name | Description |
|------|-------------|
| <a name="output_account_env_suffix"></a> [account\_env\_suffix](#output\_account\_env\_suffix) | ["prod" or "non-prod"] The AWS account shorthand to distinguish environment hierarchy. |
...
| <a name="output_cdap_env"></a> [cdap\_env](#output\_cdap\_env) | Environment is account-level, so resources generated by CDAP will<br/>be either non-prod or prod, or test or prod. |
| <a name="output_cdap_public_ips"></a> [cdap\_public\_ips](#output\_cdap\_public\_ips) | NAT Gateway IP that is used by CDAP to run core services, such as Datadog Private Location. |
